...
import 'package:compreai/Salao/cart_modelTwo.dart';
...
class CartTileTwo extends StatelessWidget {
  final CartProductTwo cartProduct;

  CartTileTwo(this.cartProduct);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      IconButton(
                        icon: Icon(Icons.add),
                        onPressed: () {
                          CartModelTwo.of(context).incProduct(cartProduct);
                        },
                      ),
                      FlatButton(
                        onPressed: () {
                          CartModelTwo.of(context).removeCartItem(cartProduct);
                        },
                        child: Text("Remover"),
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    cartProduct.productData =
                        ProductDataTwo.fromDocument(snapshot.data);
